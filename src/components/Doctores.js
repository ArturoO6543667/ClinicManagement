...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            form_data.append("Sebas", "Valor");


            for (var key in this.editedItem) {
                form_data.append(key, this.editedItem[key]);
            }

            console.log("Este es el formdata", form_data);

            axios
                .post(this.url + "/api/v1/Doctor", form_data, { headers: { 'Content-Type': 'multipart/form-data' } })
                .then((response) => {
                    let respuesta = response.data;
                    console.log(
                        "Esta es la respuesta del servidor en el store",
        ...
        // },
        saveDiaDoctor() {
            this.diaDoctor.diaKey = this.dia.diaKey;
            this.diaDoctor.doctorKey = this.editedItem.key;
            axios
        ...
        aplicarBusqueda() {
            console.log("busqueda..", this.form_data);
            this.listDoctores();
        },
        confirmarDias() {
